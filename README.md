...
<p>15. Create an admin user from the server folder:</p>

```
cd server
node createAdminUser.js YourEmail "Your Password"
```

<p>16. Admin route: <a href="http://localhost:3000/admin" target="_blank">http://localhost:3000/admin</a></p>
