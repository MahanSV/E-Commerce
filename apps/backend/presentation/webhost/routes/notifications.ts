...
router.get('/:userId/unread-count', authenticate, NotificationsController.getUnreadCount);

// GET /api/notifications/:userId - Get user notifications with filtering and pagination
router.get('/:userId', authenticate, NotificationsController.getUserNotifications);
...
router.post('/mark-read', authenticate, NotificationsController.bulkMarkAsRead);

// DELETE /api/notifications/bulk - Bulk delete notifications
router.delete('/bulk', authenticate, NotificationsController.bulkDeleteNotifications);

// PUT /api/notifications/:id - Update notification (mark as read/unread)
router.put('/:id', authenticate, NotificationsController.updateNotification);
